...
class WPRI_Admin {
	...
	public function member_fields( $user )
	{
		...
		echo '<td><textarea id="bs_uni" name="bs_uni" cols="70" rows="1">'. get_user_meta($user,'bs_uni',true) .'</textarea>';
		echo '<span class="description">Write uni.</span>';
		echo '</td></tr>';
		echo '<tr>';
		echo '<th><label">Program</label></th>';
		echo '<td><textarea id="bs_prog" name="bs_prog" cols="70" rows="1">'. get_user_meta($user,'bs_prog',true) .'</textarea>';
	    ...
	    echo '<table class="form-table">';
		echo '<th><label">Title</label></th>';
		echo '<td><textarea id="ms_title" name="ms_title" cols="70" rows="1">'. get_user_meta($user,'ms_title',true) .'</textarea>';
		echo '<span class="description">MSc, MBA, etc .</span>';
		echo '</td></tr>';
	 	echo '<tr>';
		echo '<th><label">University</label></th>';
		echo '<td><textarea id="ms_uni" name="ms_uni" cols="70" rows="1">'. get_user_meta($user,'ms_uni',true) .'</textarea>';
		echo '<span class="description">Write uni/dept name.</span>';
		echo '</td></tr>';
		echo '<tr>';
		echo '<th><label">Program</label></th>';
		echo '<td><textarea id="ms_prog" name="ms_prog" cols="70" rows="1">'. get_user_meta($user,'ms_prog',true) .'</textarea>';
		echo '<span class="description">Write program.</span>';
		echo '</td></tr>';
	 	echo '<tr>';
		echo '<th><label">Year</label></th>';
		echo '<td><textarea id="ms_year" name="ms_year" cols="4" rows="1">'. get_user_meta($user,'ms_year',true) .'</textarea>';
		echo '<span class="description">Graduation year</span>';
		echo '</td></tr>';
	 	echo '<tr>';
	    echo '</table>';
		...
		echo '<tr>';
		echo '<th><label">Title</label></th>';
		echo '<td><textarea id="phd_title" name="phd_title" cols="70" rows="1">'. get_user_meta($user,'phd_title',true) .'</textarea>';
		echo '<span class="description">Dr. or PhD .</span>';
		echo '</td></tr>';
		echo '<tr>';
		echo '<th><label">University</label></th>';
		echo '<td><textarea id="phd_uni" name="phd_uni" cols="70" rows="1">'. get_user_meta($user,'phd_uni',true) .'</textarea>';
		echo '<span class="description">Write uni/dept name.</span>';
		echo '</td></tr>';
		echo '<tr>';
		echo '<th><label">Program</label></th>';
		echo '<td><textarea id="phd_prog" name="phd_prog" cols="70" rows="1">'. get_user_meta($user,'phd_prog',true) .'</textarea>';
		echo '<span class="description">Write program.</span>';
		echo '</td></tr>';
	 	echo '<tr>';
		echo '<th><label">Year</label></th>';
		echo '<td><textarea id="phd_year" name="phd_year" cols="4" rows="1">'. get_user_meta($user,'phd_year',true) .'</textarea>';
		echo '<span class="description">Graduation year</span>';
		echo '</td></tr>';
	 	echo '<tr>';
	    echo '</table>';
