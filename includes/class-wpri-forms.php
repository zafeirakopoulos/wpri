					...
					elseif ($element["type"]== "multiple-select"){
                        ...
                        if ( ! function_exists( 'wp_handle_upload' ) ) {require_once( ABSPATH . 'wp-admin/includes/file.php' );}
                            ...
                            if ( $project_picture && ! isset( $project_picture['error'] ) ) {
                         	$plain[$element["name"]] = $project_picture["url"];
                        } else {
                            /**
                            * Error generated by _wp_handle_upload()
                            * @see _wp_handle_upload() in wp-admin/includes/file.php
                            */
                            echo $project_picture['error'];
                        }
					} else{
						$plain[$element["name"]] = $_POST[$element["name"]];
					}
...
// }
							...
							<?php
								...
								if (isset($relation["select"]["table"])){
									$all_options = WPRI_Database::get_all($relation["select"]["table"]);
									foreach ($all_options as $option){
										echo "<div  class='col-sm-12 form-element-value' >".$option[$relation["select"]["display_column"]];
		...
		?>
			<ul>
				  ...
				  <?php
				  	foreach ( $all_entries as $item ) {
					  echo "<li><table><tr>";
					  echo "<td>".$item[$form["display_element"]]."</td>";
                      echo "<td><form name='id' method='post' action=''>";
					  echo "<input type='submit' name='delete_button' value='Delete' class='btn btn-primary' /> ";
					  echo '<input type="hidden" name="id" value="'.$item["id"].'"/>';
					  echo "</form></td>";
                      echo "<td><form name='id' method='post' action='#add_update'>";
